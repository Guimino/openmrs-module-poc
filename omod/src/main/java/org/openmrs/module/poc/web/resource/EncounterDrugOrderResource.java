...
@Resource(name = RestConstants.VERSION_1 + "/encounterwrap", supportedClass = Encounter.class, supportedOpenmrsVersions = {
        "1.9.*", "1.10.*", "1.11.*", "1.12.*", "2.0.*" })
public class EncounterDrugOrderResource extends EncounterResource1_9 {
	...
	protected PageableResult doSearch(final RequestContext context) {
		...
		if ((patient != null) && (encounterType != null)) {
			...
			return new NeedsPagingEncounterDrugOrder<>(Context.getService(PocHeuristicService.class)
